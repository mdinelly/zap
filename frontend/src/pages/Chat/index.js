...
const Chat = () => {
  ...
  const handleDeleteQuickAnswers = async (quickAnswerId) => {
    try {
      ...
      toast.success(i18n.t("chat.toasts.deleted"));
    } catch (err) {
      toastError(err);
    }
    ...
    <MainContainer>
      <ConfirmationModal
        title={
          ...
          `${i18n.t("chat.confirmationModal.deleteTitle")} ${
      ...
      >
        {i18n.t("chat.confirmationModal.deleteMessage")}
      </ConfirmationModal>
      <ChatModal
          ...
          <TableHead>
            <TableRow>
              <TableCell align="center">
                {i18n.t("chat.table.shortcut")}
              </TableCell>
              <TableCell align="center">
                {i18n.t("chat.table.message")}
              </TableCell>
              <TableCell align="center">
                {i18n.t("chat.table.actions")}
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
