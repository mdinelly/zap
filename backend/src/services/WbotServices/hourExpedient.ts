...
const hourExpedient = async () => {
  ...
  workHour.map(value => {
    ...
    const verifyWeekendWorkHour = value.startWorkHourWeekend <= horaAtual && value.endWorkHourWeekend >= horaAtual;
